...
public class OSDSyncBlock implements IMessage {
    ...
    public OSDSyncBlock(String key, int distance) { this.key = key; this.distance = distance; }

    public OSDSyncBlock(FriendlyByteBuf buf) { this.key = buf.readUtf(); this.distance = buf.readInt(); }
