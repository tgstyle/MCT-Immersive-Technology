...
public record ITIMessageContainerData(List<Pair<Integer, DataPair<?>>> synced) implements ITIMessage {
    public ITIMessageContainerData(FriendlyByteBuf buf) { this(readSynced(buf)); }
