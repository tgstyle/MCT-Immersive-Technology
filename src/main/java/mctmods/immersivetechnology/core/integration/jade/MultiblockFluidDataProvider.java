...
public class MultiblockFluidDataProvider implements IServerExtensionProvider<Object, CompoundTag>, IClientExtensionProvider<CompoundTag, FluidView> {
    ...
    public ResourceLocation getUid() {
        return Reference.rl("multiblock_fluid");
    }
}
