...
public class JEIRecipeTypes {
    ...
    public static final RecipeType<RadiatorRecipe> RADIATOR = create(ITRecipeTypes.RADIATOR);
    public static final RecipeType<MeltingRecipe> MELTING = create(ITRecipeTypes.MELTING);
