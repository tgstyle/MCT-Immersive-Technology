...
public class ITLayeredComparatorOutput<CTX> {
    ...
    public ITLayeredComparatorOutput(double maxValue, int numLayers, ObjIntConsumer<CTX> updateMaster, LayerUpdater<CTX> updateLayer) {
