...
public enum TranslationKey {
    CATEGORY_BOILER_LIQUID_HEAT("category." + ITLib.MODID + ".metal_multiblock.boiler_liquid.heat"),
    CATEGORY_BOILER_LIQUID_TIME("category." + ITLib.MODID + ".metal_multiblock.boiler_liquid.time"),
    CATEGORY_BOILER_SOLID_HEAT("category." + ITLib.MODID + ".metal_multiblock.boiler_solid.heat"),
    CATEGORY_BOILER_SOLID_TIME("category." + ITLib.MODID + ".metal_multiblock.boiler_solid.time"),
    CATEGORY_DISTILLER_CHANCE("category." + ITLib.MODID + ".metal_multiblock.distiller.chance"),
    CATEGORY_HEAT_EXCHANGER_ENERGY("category." + ITLib.MODID + ".metal_multiblock.heat_exchanger.energy"),
    CATEGORY_HEAT_EXCHANGER_TIME("category." + ITLib.MODID + ".metal_multiblock.heat_exchanger.time"),
    ...
    GUI_BOILER_HEAT_PER_TICK("gui." + ITLib.MODID + ".boiler.heat_per_tick"),
    GUI_BOILER_TOTAL_HEAT("gui." + ITLib.MODID + ".boiler.total_heat"),
    ...
    GUI_GENERIC_MULTIBLOCK_TOOLTIP("gui." + ITLib.MODID + ".generic_multiblock_jei_tooltip"),
    GUI_HEAT_LEVEL("gui." + ITLib.MODID + ".heat_level"),
    GUI_HEAT_LEVEL_DETAILED("gui." + ITLib.MODID + ".heat_level_detailed"),
    GUI_IF_PER_TICK("gui." + ITLib.MODID + ".if_per_tick"),
    ...
    GUI_SECONDS("gui." + ITLib.MODID + ".seconds"),
    ...
    GUI_TICKS("gui." + ITLib.MODID + ".ticks"),
    GUI_TIMER("gui." + ITLib.MODID + ".timer"),
    GUI_TIMER_CHANNEL("gui." + ITLib.MODID + ".timer.channel"),
    GUI_TIMER_MODE("gui." + ITLib.MODID + ".timer.mode"),
    GUI_TIMER_TOGGLE("gui." + ITLib.MODID + ".timer.toggle"),
