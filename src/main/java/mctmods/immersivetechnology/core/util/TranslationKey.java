...
public enum TranslationKey {
    ...
    DESC_HOLD_SHIFT_FOR_INFO("desc." + Reference.MODID + ".info.holdShiftForInfo"),
    ...
    GUI_ENERGY_STORED("gui." + Reference.MODID + ".energy_stored"),
    GUI_FLUID_AMOUNT("gui." + Reference.MODID + ".fluid_amount"),
    GUI_FLUID_CAPACITY("gui." + Reference.MODID + ".fluid_capacity"),
    GUI_FLUID_DENSITY("gui." + Reference.MODID + ".fluid_density"),
    GUI_FLUID_NBT("gui." + Reference.MODID + ".fluid_nbt"),
    GUI_FLUID_REGISTRY("gui." + Reference.MODID + ".fluid_registry"),
    GUI_FLUID_TEMPERATURE("gui." + Reference.MODID + ".fluid_temperature"),
    GUI_FLUID_VISCOSITY("gui." + Reference.MODID + ".fluid_viscosity"),
    GUI_FUEL_EMPTY("gui." + Reference.MODID + ".fuel_empty"),
    ...
    GUI_ROTOR_CREATIVE("gui." + Reference.MODID + ".rotor_creative"),
    GUI_ROTOR_CREATIVE_RPM("gui." + Reference.MODID + ".rotor_creative_rpm"),
    GUI_STATUS("gui." + Reference.MODID + ".status"),
    GUI_STATUS_ACTIVE("gui." + Reference.MODID + ".status_active"),
    GUI_STATUS_INACTIVE("gui." + Reference.MODID + ".status_inactive"),
    GUI_TEMPERATURE("gui." + Reference.MODID + ".temperature"),
    GUI_TIMER("gui." + Reference.MODID + ".timer"),
    GUI_TIMER_CHANNEL("gui." + Reference.MODID + ".timer.channel"),
    GUI_TIMER_MODE("gui." + Reference.MODID + ".timer.mode"),
    GUI_TIMER_TOGGLE("gui." + Reference.MODID + ".timer.toggle"),
