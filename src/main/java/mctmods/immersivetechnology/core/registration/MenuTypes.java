...
public class MenuTypes {
    ...
    public static class MultiblockContainer<S extends IMultiblockState, C extends ContainerMenu> extends ArgContainer<ContainerMenu.MultiblockMenuContext<S>, C> {
        private MultiblockContainer(java.util.function.Supplier<MenuType<C>> type, IArgContainerConstructor<ContainerMenu.MultiblockMenuContext<S>, C> factory) { super(type, factory); }
    ...
    private static <C extends ContainerMenu> java.util.function.Supplier<MenuType<C>> registerType(String name, IClientContainerConstructor<C> client) {
