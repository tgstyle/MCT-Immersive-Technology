...
public class ModObjLoader implements IGeometryLoader<ModObjLoader.ITObjModel> {
    public static final ModObjLoader INSTANCE = new ModObjLoader();

    private ModObjLoader() {}
