...
public class ITSplitModelLoader implements IGeometryLoader<ITUnbakedSplitModel> {
    ...
    private ITSplitModelLoader() {}

    @Nonnull @Override public ITUnbakedSplitModel read(JsonObject modelContents, @Nonnull JsonDeserializationContext deserializationContext) {
