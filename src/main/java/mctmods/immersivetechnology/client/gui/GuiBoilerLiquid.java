...
public class GuiBoilerLiquid extends GuiICContainerBase {
	private static final String TEXTURE = "immersivetech:textures/gui/boiler_liquid.png";
	...
	@Override public void drawScreen(int mx, int my, float partial) {
		...
		ICClientUtils.handleGuiTank(tile.tanks[0], guiLeft + 80, guiTop + 20, 16, 47, 177, 31, 20, 51, mx, my, TEXTURE, tooltip);
	...
	@Override protected void drawGuiContainerBackgroundLayer(float f, int mx, int my) {
		...
		ICClientUtils.handleGuiTank(tile.tanks[0], guiLeft + 80, guiTop + 20, 16, 47, 177, 31, 20, 51, mx, my, TEXTURE, null);
	}
}
