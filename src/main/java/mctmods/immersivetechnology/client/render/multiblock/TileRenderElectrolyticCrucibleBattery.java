...
public class TileRenderElectrolyticCrucibleBattery extends TileEntitySpecialRenderer<TileEntityElectrolyticCrucibleBatteryMaster> {
    @Override public void render(TileEntityElectrolyticCrucibleBatteryMaster te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        if (!te.formed) { return; }
        ...
        int totalBlocks = TileEntityITMultiblockPartElectrolyticCrucibleBattery.instance.width * TileEntityITMultiblockPartElectrolyticCrucibleBattery.instance.length * TileEntityITMultiblockPartElectrolyticCrucibleBattery.instance.height;
    ...
    @Override public boolean isGlobalRenderer(@Nonnull TileEntityElectrolyticCrucibleBatteryMaster te) { return true; }
}
