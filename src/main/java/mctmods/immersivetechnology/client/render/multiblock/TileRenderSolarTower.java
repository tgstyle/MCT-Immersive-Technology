...
public class TileRenderSolarTower extends TileEntitySpecialRenderer<TileEntitySolarTowerMaster> {
    @Override public void render(TileEntitySolarTowerMaster te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        if (!te.formed) { return; }
        ...
        int totalBlocks = TileEntityITMultiblockPartSolarTower.instance.width * TileEntityITMultiblockPartSolarTower.instance.length * TileEntityITMultiblockPartSolarTower.instance.height;
    ...
    @Override public boolean isGlobalRenderer(@Nonnull TileEntitySolarTowerMaster te) { return true; }
}
