...
public class TileRenderBoiler extends TileEntitySpecialRenderer<TileEntityBoilerMaster> {
    @Override public void render(TileEntityBoilerMaster te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        if (!te.formed) { return; }
        ...
        int totalBlocks = TileEntityITMultiblockPartBoiler.instance.width * TileEntityITMultiblockPartBoiler.instance.length * TileEntityITMultiblockPartBoiler.instance.height;
    ...
    @Override public boolean isGlobalRenderer(@Nonnull TileEntityBoilerMaster te) { return true; }
}
