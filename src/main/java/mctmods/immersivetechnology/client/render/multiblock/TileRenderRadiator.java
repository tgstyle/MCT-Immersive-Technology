...
public class TileRenderRadiator extends TileEntitySpecialRenderer<TileEntityRadiatorMaster> {
    @Override public void render(TileEntityRadiatorMaster te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        if (!te.formed) { return; }
        ...
        int totalBlocks = TileEntityITMultiblockPartRadiator.instance.width * TileEntityITMultiblockPartRadiator.instance.length * TileEntityITMultiblockPartRadiator.instance.height;
