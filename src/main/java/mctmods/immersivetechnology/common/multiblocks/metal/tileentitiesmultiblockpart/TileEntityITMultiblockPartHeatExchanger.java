...
public class TileEntityITMultiblockPartHeatExchanger extends MachineTemplateMultiblock<TileEntityHeatExchangerSlave> {
    ...
    public TileEntityITMultiblockPartHeatExchanger() { super("IT:HeatExchanger", ITShapes.get("heat_exchanger"), ITUtils.stateOf(ITContent.blockMetalMultiblock1, BlockType_MetalMultiblock1.HEAT_EXCHANGER), ITUtils.stateOf(ITContent.blockMetalMultiblock1, BlockType_MetalMultiblock1.HEAT_EXCHANGER_SLAVE)); }
