...
public class ElectrolyticCrucibleBatteryShape {
    public static final MultiblockData DATA = MultiblockDataLoader.loadMultiblockData(Reference.class, Reference.MODID, "electrolytic_crucible_battery");
    private static final ShapeData SHAPE = ShapeData.load(Reference.class, Reference.MODID, "electrolytic_crucible_battery", "metal");
