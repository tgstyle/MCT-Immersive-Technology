...
public class TileEntityITMultiblockPartSolarMelter extends TileEntityITMultiblockPart<TileEntitySolarMelterSlave> {
    public static TileEntityITMultiblockPartSolarMelter instance = new TileEntityITMultiblockPartSolarMelter();

    @SideOnly(Side.CLIENT)
    static ItemStack renderStack;

    public TileEntityITMultiblockPartSolarMelter() { super("IT:SolarMelter", SolarMelterShape.SHAPE, ITContent.blockMetalMultiblock1.getStateFromMeta(BlockType_MetalMultiblock1.SOLAR_MELTER.getMeta()), ITContent.blockMetalMultiblock1.getStateFromMeta(BlockType_MetalMultiblock1.SOLAR_MELTER_SLAVE.getMeta())); }
