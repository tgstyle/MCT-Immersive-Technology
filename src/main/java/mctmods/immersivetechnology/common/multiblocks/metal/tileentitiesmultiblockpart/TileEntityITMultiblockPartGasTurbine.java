...
public class TileEntityITMultiblockPartGasTurbine extends MachineTemplateMultiblock<TileEntityGasTurbineSlave> {
    ...
    public TileEntityITMultiblockPartGasTurbine() { super("IT:GasTurbine", ITShapes.get("gas_turbine"), ICUtils.stateOf(ITContent.blockMetalMultiblock1, BlockType_MetalMultiblock1.GAS_TURBINE), ICUtils.stateOf(ITContent.blockMetalMultiblock1, BlockType_MetalMultiblock1.GAS_TURBINE_SLAVE)); }
