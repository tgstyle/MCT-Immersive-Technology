...
public class RadiatorHorizontalShape {
    public static final MultiblockData DATA = MultiblockDataLoader.loadMultiblockData(Reference.class, Reference.MODID, "radiator_horizontal");
    private static final ShapeData SHAPE = ShapeData.load(Reference.class, Reference.MODID, "radiator_horizontal", "metal");
