...
public class TileEntityITMultiblockPartDistiller extends MachineTemplateMultiblock<TileEntityDistillerSlave> {
    ...
    public TileEntityITMultiblockPartDistiller() { super("IT:Distiller", ITShapes.get("distiller"), ICUtils.stateOf(ITContent.blockMetalMultiblock, BlockType_MetalMultiblock.DISTILLER), ICUtils.stateOf(ITContent.blockMetalMultiblock, BlockType_MetalMultiblock.DISTILLER_SLAVE)); }
