...
public class TileEntityITMultiblockPartBoilerTank extends MachineTemplateMultiblock<TileEntityBoilerTankSlave> {
    ...
    public TileEntityITMultiblockPartBoilerTank() { super("IT:BoilerTank", ITShapes.get("boiler_tank"), ICUtils.stateOf(ITContent.blockMetalMultiblock, BlockType_MetalMultiblock.BOILER_TANK), ICUtils.stateOf(ITContent.blockMetalMultiblock, BlockType_MetalMultiblock.BOILER_TANK_SLAVE)); }
