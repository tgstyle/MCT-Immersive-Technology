...
public class SolarTowerShape {
    public static final MultiblockData DATA = MultiblockDataLoader.loadMultiblockData(Reference.class, Reference.MODID, "solar_tower");
    private static final ShapeData SHAPE = ShapeData.load(Reference.class, Reference.MODID, "solar_tower", "metal");
