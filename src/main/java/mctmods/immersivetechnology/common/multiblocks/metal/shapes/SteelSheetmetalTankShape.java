...
public class SteelSheetmetalTankShape {
    public static final MultiblockData DATA = MultiblockDataLoader.loadMultiblockData(Reference.class, Reference.MODID, "steel_sheetmetal_tank");
    private static final ShapeData SHAPE = ShapeData.load(Reference.class, Reference.MODID, "steel_sheetmetal_tank", "metal");
