...
public class SolarReflector extends ITTemplateMultiblock {
    ...
    @Override public float getManualScale() { return SolarReflectorShape.MANUAL_SCALE; }

    @Override public void initializeClient(Consumer<ClientMultiblocks.MultiblockManualData> consumer) { consumer.accept(new ITClientMultiblockProperties(this, SolarReflectorShape.CLIENT_OFFSET.getX(), SolarReflectorShape.CLIENT_OFFSET.getY(), SolarReflectorShape.CLIENT_OFFSET.getZ())); }
