...
public class SolarReflector extends ITTemplateMultiblock {
    ...
    public SolarReflector() { super(ITLib.rl("multiblocks/solar_reflector"), SolarReflectorShape.MASTER_POS, SolarReflectorShape.TRIGGER_POS, new BlockPos(SolarReflectorShape.WIDTH,SolarReflectorShape.HEIGHT,SolarReflectorShape.LENGTH), SolarReflectorShape.CLIENT_OFFSET, SolarReflectorShape.MANUAL_SCALE, ITMultiblockRegistry.SOLAR_REFLECTOR); }
