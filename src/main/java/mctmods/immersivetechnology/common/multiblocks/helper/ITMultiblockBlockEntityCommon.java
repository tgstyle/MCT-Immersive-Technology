...
public class ITMultiblockBlockEntityCommon<State extends IMultiblockState> implements ITIBlockInterfaces.IPlayerInteraction, ITIDropInventory, ITIModelOffsetProvider {
