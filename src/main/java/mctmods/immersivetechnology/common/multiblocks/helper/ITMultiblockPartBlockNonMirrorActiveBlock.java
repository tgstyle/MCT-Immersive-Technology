...
public class ITMultiblockPartBlockNonMirrorActiveBlock<S extends IMultiblockState> extends ITMultiblockPartBlock<S> {
    public static final Property<Boolean> ACTIVE;

    public ITMultiblockPartBlockNonMirrorActiveBlock(BlockBehaviour.Properties properties, MultiblockRegistration<S> multiblock) {
