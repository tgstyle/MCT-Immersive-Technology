...
public class ITIMultiblockBlockEntityCommon<State extends IMultiblockState> implements ITBlockInterfaces.IPlayerInteraction, ITIDropInventory, ITIModelOffsetProvider {
    ...
    public ITIMultiblockBlockEntityCommon(MultiblockRegistration<State> multiblock, Supplier<IMultiblockBEHelper<State>> helperSupplier, Supplier<Level> levelSupplier) {
