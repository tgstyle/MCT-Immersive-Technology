...
public class MeltingCrucibleRecipeWrapper extends ITMultiblockRecipeWrapper {
	...
	@Override @SideOnly(Side.CLIENT) public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) { drawTimeText(minecraft, recipe.getTotalProcessTime(), 59, 8); }
}
