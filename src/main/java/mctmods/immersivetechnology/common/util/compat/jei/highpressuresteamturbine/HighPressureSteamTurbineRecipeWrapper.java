...
public class HighPressureSteamTurbineRecipeWrapper extends ITMultiblockRecipeWrapper {
	public MultiblockRecipeBase recipe;

	public HighPressureSteamTurbineRecipeWrapper(MultiblockRecipeBase recipe) {
		super(recipe);
		this.recipe = recipe;
	}
