...
public class HighPressureSteamTurbineRecipeCategory extends ITRecipeCategory<HighPressureSteamTurbineRecipe, HighPressureSteamTurbineRecipeWrapper> {
	...
	@Override @Nonnull public IRecipeWrapper getRecipeWrapper(@Nonnull HighPressureSteamTurbineRecipe recipe) { return new HighPressureSteamTurbineRecipeWrapper(recipe); }
