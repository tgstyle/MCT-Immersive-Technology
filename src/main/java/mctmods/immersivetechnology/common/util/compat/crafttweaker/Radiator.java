...
public class Radiator {
    ...
    private static class Add implements IAction {
        ...
        @Override
        public void apply() { RadiatorRecipe.recipeList.add(recipe); }
        @Override
        public String describe() { return "Adding Radiator Recipe for " + recipe.fluidInput.getLocalizedName() + " -> " + recipe.fluidOutput.getLocalizedName(); }
    }
    ...
    private static class Remove implements IAction {
        ...
        @Override
        public void apply() {
            RadiatorRecipe.recipeList.removeIf(recipe -> recipe != null && recipe.fluidInput.isFluidEqual(inputFluid));
        }
        @Override
        public String describe() { return "Removing Radiator Input Recipe for " + inputFluid.getLocalizedName(); }
    }
}
