...
public class ITRecipeLoader {
    public static void loadRecipes() {
        ...
        MultiblockRecipeLoader.registerType("immersivetech:boiler_solid", (json, context) -> {
            ...
            Object itemInput = input.has("ore") ? new ICIngredientStack(JsonUtils.getString(input, "ore"), count) : CraftingHelper.getItemStack(input, context);
        ...
        MultiblockRecipeLoader.registerType("immersivetech:steam_turbine", (json, context) -> SteamTurbineRecipe.addFuel(getFluidStack(json, "output"), getFluidStack(json, "input"), JsonUtils.getInt(json, "time"), JsonUtils.getFloat(json, "torque", SteamTurbineRecipe.defaultTorque())));
        MultiblockRecipeLoader.registerType("immersivetech:high_pressure_steam_turbine", (json, context) -> HighPressureSteamTurbineRecipe.addFuel(getFluidStack(json, "output"), getFluidStack(json, "input"), JsonUtils.getInt(json, "time"), JsonUtils.getFloat(json, "torque", HighPressureSteamTurbineRecipe.defaultTorque())));
        MultiblockRecipeLoader.registerType("immersivetech:gas_turbine", (json, context) -> GasTurbineRecipe.addFuel(getFluidStack(json, "output"), getFluidStack(json, "input"), JsonUtils.getInt(json, "time"), JsonUtils.getFloat(json, "torque", GasTurbineRecipe.defaultTorque())));
