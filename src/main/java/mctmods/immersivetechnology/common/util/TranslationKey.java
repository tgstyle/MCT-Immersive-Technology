...
public enum TranslationKey {
    ...
    GUI_VALVE_FLUID_FIRST_LINE("gui.immersivetechnology.valve_fluid.firstline"),
    GUI_VALVE_FLUID_LIMIT_DESTINATION("gui.immersivetechnology.valve_fluid.limitdestination"),
    GUI_VALVE_FLUID_LIMIT_PACKET("gui.immersivetechnology.valve_fluid.limitpacket"),
    GUI_VALVE_FLUID_LIMIT_TIME("gui.immersivetechnology.valve_fluid.limittime"),
