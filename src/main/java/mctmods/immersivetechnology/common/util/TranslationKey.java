...
public enum TranslationKey {
    ...
    OVERLAY_OSD_CREATIVE_CRATE_SNEAKING_FIRST_LINE("overlay.immersivetech.osd.creative_crate.sneaking.firstline"),
    OVERLAY_OSD_CREATIVE_CRATE_SNEAKING_SECOND_LINE("overlay.immersivetech.osd.creative_crate.sneaking.secondline"),
