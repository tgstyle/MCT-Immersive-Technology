...
public class ITDelegatingFluidTank extends ITMarkableFluidTank {
    private final ITMarkableFluidTank delegate;

    public ITDelegatingFluidTank(ITMarkableFluidTank delegate) {
