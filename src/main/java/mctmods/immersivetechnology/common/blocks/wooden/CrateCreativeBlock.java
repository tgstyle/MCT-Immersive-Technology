...
public class CrateCreativeBlock extends ModEntityBlock<CrateCreativeBlockEntity> {
    ...
    @Override public @NotNull InteractionResult useWithoutItem(@NotNull BlockState state, @NotNull Level level, @NotNull BlockPos pos, @NotNull Player player, @NotNull BlockHitResult hit) {
        ...
        if (tile != null && player instanceof ServerPlayer serverPlayer) {
            serverPlayer.openMenu(tile, b -> b.writeBlockPos(pos));
        }
