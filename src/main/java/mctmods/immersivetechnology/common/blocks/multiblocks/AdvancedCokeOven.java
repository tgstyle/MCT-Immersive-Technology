...
public class AdvancedCokeOven extends ITTemplateMultiblock {
    ...
    public AdvancedCokeOven() { super(ResourceLocation.fromNamespaceAndPath(ITLib.MODID, "multiblocks/advanced_coke_oven"), new BlockPos(0,0,0), new BlockPos(1,1,2), new BlockPos(3,4,3), ITMultiblockProvider.ADVANCED_COKE_OVEN); }
