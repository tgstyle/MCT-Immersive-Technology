...
public class SolarTowerShape extends GenericShape {
    ...
    protected List<AABB> getShape(BlockPos posInMultiblock) {
        ...
        if (bX == 0 && bY == 4 && bZ == 1) {
            ...
            main.add(new AABB(0.3750D, 0.4375D, 0.2500D, 1.0000D, 1.0000D, 0.3125D));
            main.add(new AABB(0.3750D, 0.4375D, 0.6875D, 1.0000D, 1.0000D, 0.7500D));
            main.add(new AABB(0.3750D, 0.6875D, 0.3125D, 1.0000D, 1.0000D, 0.3750D));
            main.add(new AABB(0.3750D, 0.6875D, 0.6250D, 1.0000D, 1.0000D, 0.6875D));
            ...
            main.add(new AABB(0.3750D, 0.9375D, 0.3750D, 1.0000D, 1.0000D, 0.6250D));
            main.add(new AABB(0.7500D, 0.0000D, 0.2500D, 1.0000D, 0.4375D, 0.7500D));
            main.add(new AABB(0.7500D, 0.4375D, 0.3125D, 1.0000D, 0.6875D, 0.6875D));
            main.add(new AABB(0.7500D, 0.6875D, 0.3750D, 1.0000D, 0.9375D, 0.6250D));
        }
        if (bX == 0 && bY == 4 && bZ == 2) {
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 1.0000D, 0.6875D));
        ...
        if (bX == 0 && bY == 5 && bZ == 1) {
            main.add(new AABB(0.3125D, 0.5000D, 0.2500D, 1.0000D, 1.0000D, 0.7500D));
            ...
            main.add(new AABB(0.6250D, 0.0000D, 0.2500D, 1.0000D, 0.5000D, 0.7500D));
        }
        if (bX == 0 && bY == 5 && bZ == 2) {
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 1.0000D, 0.6875D));
        }
        ...
        if (bX == 0 && bY == 6 && bZ == 1) {
            main.add(new AABB(0.3125D, 0.0000D, 0.2500D, 1.0000D, 0.5000D, 0.7500D));
            main.add(new AABB(0.3750D, 0.4375D, 0.1875D, 0.6250D, 1.0000D, 0.2500D));
            main.add(new AABB(0.3750D, 0.4375D, 0.7500D, 0.6250D, 1.0000D, 0.8125D));
            main.add(new AABB(0.3750D, 0.5000D, 0.2500D, 1.0000D, 1.0000D, 0.7500D));
            main.add(new AABB(0.3750D, 0.6875D, 0.1250D, 0.6250D, 1.0000D, 0.1875D));
            main.add(new AABB(0.3750D, 0.6875D, 0.8125D, 0.6250D, 1.0000D, 0.8750D));
        }
        if (bX == 0 && bY == 6 && bZ == 2) {
        ...
        if (bX == 0 && bY == 7 && bZ == 1) {
            ...
            main.add(new AABB(0.3750D, 0.0000D, 0.2500D, 1.0000D, 0.5625D, 0.3125D));
            main.add(new AABB(0.3750D, 0.0000D, 0.3125D, 1.0000D, 0.0625D, 0.7500D));
            main.add(new AABB(0.3750D, 0.0000D, 0.7500D, 0.6250D, 0.8125D, 0.9375D));
            main.add(new AABB(0.3750D, 0.0625D, 0.3125D, 1.0000D, 0.3125D, 0.3750D));
            main.add(new AABB(0.3750D, 0.0625D, 0.6250D, 1.0000D, 0.3125D, 0.7500D));
            main.add(new AABB(0.3750D, 0.1875D, 0.0000D, 0.6250D, 1.0000D, 0.0625D));
            main.add(new AABB(0.3750D, 0.1875D, 0.9375D, 0.6250D, 1.0000D, 1.0000D));
            main.add(new AABB(0.3750D, 0.3125D, 0.6875D, 1.0000D, 0.5625D, 0.7500D));
            main.add(new AABB(0.3750D, 0.8125D, 0.8125D, 0.6250D, 1.0000D, 0.9375D));
            main.add(new AABB(0.7500D, 0.0625D, 0.3750D, 1.0000D, 1.0000D, 0.6250D));
            main.add(new AABB(0.7500D, 0.3125D, 0.3125D, 1.0000D, 1.0000D, 0.3750D));
            main.add(new AABB(0.7500D, 0.3125D, 0.6250D, 1.0000D, 1.0000D, 0.6875D));
            main.add(new AABB(0.7500D, 0.5625D, 0.2500D, 1.0000D, 1.0000D, 0.3125D));
            main.add(new AABB(0.7500D, 0.5625D, 0.6875D, 1.0000D, 1.0000D, 0.7500D));
        }
        if (bX == 0 && bY == 7 && bZ == 2) {
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 1.0000D, 0.6875D));
            main.add(new AABB(0.3750D, 0.4375D, 0.0000D, 0.6250D, 1.0000D, 0.0625D));
        ...
        if (bX == 0 && bY == 9 && bZ == 0) {
            ...
            main.add(new AABB(0.6875D, 0.0000D, 0.3750D, 0.7500D, 0.7500D, 0.6250D));
        ...
        if (bX == 0 && bY == 9 && bZ == 2) {
            ...
            main.add(new AABB(0.3750D, 0.5625D, 0.2500D, 0.6250D, 0.7500D, 0.3125D));
            main.add(new AABB(0.6875D, 0.0000D, 0.3750D, 0.7500D, 0.7500D, 0.6250D));
            main.add(new AABB(0.7500D, 0.0000D, 0.3750D, 0.8125D, 0.5625D, 0.6250D));
            main.add(new AABB(0.8125D, 0.0000D, 0.3750D, 0.8750D, 0.3125D, 0.6250D));
        }
        if (bX == 0 && bY == 10 && bZ == 0) {
            ...
            main.add(new AABB(0.6875D, 0.2500D, 0.3750D, 0.7500D, 1.0000D, 0.5000D));
            main.add(new AABB(0.7500D, 0.4375D, 0.3750D, 0.8125D, 1.0000D, 0.6250D));
            main.add(new AABB(0.8125D, 0.6875D, 0.3750D, 0.8750D, 1.0000D, 0.6250D));
        }
        if (bX == 0 && bY == 10 && bZ == 1) {
        ...
        if (bX == 0 && bY == 10 && bZ == 2) {
            ...
            main.add(new AABB(0.3750D, 0.4375D, 0.1875D, 0.6250D, 1.0000D, 0.2500D));
            main.add(new AABB(0.3750D, 0.6875D, 0.1250D, 0.6250D, 1.0000D, 0.1875D));
            main.add(new AABB(0.6875D, 0.1875D, 0.3750D, 0.7500D, 1.0000D, 0.5000D));
            main.add(new AABB(0.6875D, 0.2500D, 0.5000D, 0.7500D, 1.0000D, 0.6250D));
            main.add(new AABB(0.7500D, 0.4375D, 0.3750D, 0.8125D, 1.0000D, 0.6250D));
            main.add(new AABB(0.8125D, 0.6875D, 0.3750D, 0.8750D, 1.0000D, 0.6250D));
        }
        if (bX == 0 && bY == 11 && bZ == 0) {
        ...
        if (bX == 2 && bY == 4 && bZ == 1) {
            main.add(new AABB(0.0000D, 0.0000D, 0.2500D, 0.2500D, 1.0000D, 0.7500D));
            main.add(new AABB(0.2500D, 0.4375D, 0.2500D, 0.6250D, 1.0000D, 0.3125D));
            main.add(new AABB(0.2500D, 0.4375D, 0.6875D, 0.6250D, 1.0000D, 0.7500D));
            main.add(new AABB(0.2500D, 0.6875D, 0.3125D, 0.6250D, 1.0000D, 0.3750D));
            main.add(new AABB(0.2500D, 0.6875D, 0.6250D, 0.6250D, 1.0000D, 0.6875D));
            main.add(new AABB(0.2500D, 0.9375D, 0.3750D, 0.6250D, 1.0000D, 0.6250D));
            main.add(new AABB(0.3750D, 0.0000D, 0.0000D, 0.6250D, 0.8125D, 0.1875D));
            main.add(new AABB(0.3750D, 0.0000D, 0.8125D, 0.6250D, 0.8125D, 1.0000D));
            main.add(new AABB(0.3750D, 0.1875D, 0.1875D, 0.6250D, 1.0000D, 0.2500D));
            main.add(new AABB(0.3750D, 0.1875D, 0.7500D, 0.6250D, 1.0000D, 0.8125D));
        ...
        if (bX == 2 && bY == 5 && bZ == 1) {
            main.add(new AABB(0.0000D, 0.0000D, 0.2500D, 0.6250D, 1.0000D, 0.7500D));
            main.add(new AABB(0.3750D, 0.0000D, 0.0625D, 0.6250D, 0.0625D, 0.2500D));
            main.add(new AABB(0.3750D, 0.0000D, 0.7500D, 0.6250D, 0.5625D, 0.8125D));
            main.add(new AABB(0.3750D, 0.0000D, 0.8125D, 0.6250D, 0.3125D, 0.8750D));
            main.add(new AABB(0.3750D, 0.0625D, 0.1250D, 0.6250D, 0.3125D, 0.2500D));
            main.add(new AABB(0.3750D, 0.3125D, 0.1875D, 0.6250D, 0.5625D, 0.2500D));
            main.add(new AABB(0.6250D, 0.5000D, 0.2500D, 0.6875D, 1.0000D, 0.7500D));
        }
        if (bX == 2 && bY == 5 && bZ == 2) {
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 1.0000D, 0.6875D));
        }
        ...
        if (bX == 2 && bY == 6 && bZ == 1) {
            ...
            main.add(new AABB(0.3750D, 0.6875D, 0.1250D, 0.6250D, 1.0000D, 0.1875D));
            main.add(new AABB(0.3750D, 0.6875D, 0.8125D, 0.6250D, 1.0000D, 0.8750D));
            main.add(new AABB(0.6250D, 0.0000D, 0.2500D, 0.6875D, 0.5000D, 0.7500D));
        }
        if (bX == 2 && bY == 6 && bZ == 2) {
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 1.0000D, 0.6875D));
        }
        ...
        if (bX == 2 && bY == 7 && bZ == 1) {
            main.add(new AABB(0.0000D, 0.0000D, 0.2500D, 0.2500D, 1.0000D, 0.7500D));
            main.add(new AABB(0.2500D, 0.0000D, 0.2500D, 0.6250D, 0.5625D, 0.3125D));
            main.add(new AABB(0.2500D, 0.0000D, 0.3125D, 0.6250D, 0.0625D, 0.7500D));
            main.add(new AABB(0.2500D, 0.0625D, 0.3125D, 0.6250D, 0.3125D, 0.3750D));
            main.add(new AABB(0.2500D, 0.0625D, 0.6250D, 0.6250D, 0.3125D, 0.7500D));
            main.add(new AABB(0.2500D, 0.3125D, 0.6875D, 0.6250D, 0.5625D, 0.7500D));
            main.add(new AABB(0.3750D, 0.0000D, 0.0625D, 0.6250D, 0.8125D, 0.2500D));
            main.add(new AABB(0.3750D, 0.0000D, 0.7500D, 0.6250D, 0.8125D, 0.9375D));
            main.add(new AABB(0.3750D, 0.1875D, 0.0000D, 0.6250D, 1.0000D, 0.0625D));
            main.add(new AABB(0.3750D, 0.1875D, 0.9375D, 0.6250D, 1.0000D, 1.0000D));
            main.add(new AABB(0.3750D, 0.8125D, 0.0625D, 0.6250D, 1.0000D, 0.1875D));
        ...
        if (bX == 2 && bY == 9 && bZ == 0) {
            ...
            main.add(new AABB(0.2500D, 0.5625D, 0.3750D, 0.6875D, 0.7500D, 0.6250D));
            main.add(new AABB(0.2500D, 0.7500D, 0.5000D, 0.6875D, 0.8125D, 0.6250D));
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 1.0000D, 0.3750D));
            main.add(new AABB(0.3125D, 0.0000D, 0.6250D, 0.6875D, 1.0000D, 0.6875D));
            main.add(new AABB(0.3125D, 0.7500D, 0.3750D, 0.6875D, 1.0000D, 0.5000D));
            main.add(new AABB(0.3125D, 0.8125D, 0.5000D, 0.6875D, 1.0000D, 0.6250D));
            main.add(new AABB(0.3750D, 0.0000D, 0.6875D, 0.6250D, 0.7500D, 0.7500D));
            main.add(new AABB(0.3750D, 0.0000D, 0.7500D, 0.6250D, 0.5625D, 0.8125D));
            main.add(new AABB(0.3750D, 0.0000D, 0.8125D, 0.6250D, 0.3125D, 0.8750D));
        }
        ...
        if (bX == 2 && bY == 9 && bZ == 2) {
            ...
            main.add(new AABB(0.1875D, 0.3125D, 0.3750D, 0.6875D, 0.5625D, 0.6250D));
            main.add(new AABB(0.2500D, 0.5625D, 0.3750D, 0.6875D, 0.7500D, 0.6250D));
            main.add(new AABB(0.2500D, 0.7500D, 0.3750D, 0.6875D, 0.8125D, 0.5000D));
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 1.0000D, 0.3750D));
            main.add(new AABB(0.3125D, 0.0000D, 0.6250D, 0.6875D, 1.0000D, 0.6875D));
            main.add(new AABB(0.3125D, 0.7500D, 0.5000D, 0.6875D, 1.0000D, 0.6250D));
            main.add(new AABB(0.3125D, 0.8125D, 0.3750D, 0.6875D, 1.0000D, 0.5000D));
            main.add(new AABB(0.3750D, 0.0000D, 0.0625D, 0.6250D, 0.0625D, 0.3125D));
            main.add(new AABB(0.3750D, 0.0625D, 0.1250D, 0.6250D, 0.3125D, 0.3125D));
            main.add(new AABB(0.3750D, 0.3125D, 0.1875D, 0.6250D, 0.5625D, 0.3125D));
            main.add(new AABB(0.3750D, 0.5625D, 0.2500D, 0.6250D, 0.7500D, 0.3125D));
        ...
        if (bX == 2 && bY == 10 && bZ == 0) {
            ...
            main.add(new AABB(0.2500D, 0.2500D, 0.3750D, 0.6875D, 0.4375D, 0.5000D));
            ...
            main.add(new AABB(0.3125D, 0.1875D, 0.3750D, 0.6875D, 0.2500D, 0.5000D));
            main.add(new AABB(0.3125D, 0.1875D, 0.6250D, 0.6875D, 1.0000D, 0.6875D));
            main.add(new AABB(0.3750D, 0.1875D, 0.6875D, 0.5000D, 1.0000D, 0.7500D));
            main.add(new AABB(0.3750D, 0.4375D, 0.7500D, 0.6250D, 1.0000D, 0.8125D));
            main.add(new AABB(0.3750D, 0.6875D, 0.8125D, 0.6250D, 1.0000D, 0.8750D));
            main.add(new AABB(0.5000D, 0.2500D, 0.6875D, 0.6250D, 1.0000D, 0.7500D));
        }
        if (bX == 2 && bY == 10 && bZ == 1) {
            main.add(new AABB(0.0000D, 0.0000D, 0.2500D, 0.2500D, 1.0000D, 0.7500D));
        }
        if (bX == 2 && bY == 10 && bZ == 2) {
            ...
            main.add(new AABB(0.2500D, 0.2500D, 0.5000D, 0.6875D, 0.4375D, 0.6250D));
            main.add(new AABB(0.3125D, 0.0000D, 0.3125D, 0.6875D, 0.1875D, 0.6875D));
            main.add(new AABB(0.3125D, 0.1875D, 0.3125D, 0.6875D, 1.0000D, 0.3750D));
            main.add(new AABB(0.3125D, 0.1875D, 0.5000D, 0.6875D, 0.2500D, 0.6875D));
            main.add(new AABB(0.3125D, 0.2500D, 0.6250D, 0.6875D, 1.0000D, 0.6875D));
            main.add(new AABB(0.3750D, 0.1875D, 0.2500D, 0.5000D, 1.0000D, 0.3125D));
            main.add(new AABB(0.3750D, 0.4375D, 0.1875D, 0.6250D, 1.0000D, 0.2500D));
            main.add(new AABB(0.3750D, 0.6875D, 0.1250D, 0.6250D, 1.0000D, 0.1875D));
            main.add(new AABB(0.5000D, 0.2500D, 0.2500D, 0.6250D, 1.0000D, 0.3125D));
        }
        if (bX == 2 && bY == 11 && bZ == 0) {
            main.add(new AABB(0.0000D, 0.1875D, 0.3750D, 0.6875D, 1.0000D, 0.6250D));
            main.add(new AABB(0.0625D, 0.0000D, 0.3750D, 0.6875D, 0.1875D, 0.6250D));
