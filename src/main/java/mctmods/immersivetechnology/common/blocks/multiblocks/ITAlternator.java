...
public class ITAlternator extends ITTemplateMultiblock {
    ...
    public ITAlternator() { super(ResourceLocation.fromNamespaceAndPath(ITLib.MODID, "multiblocks/alternator"), new BlockPos(0,0,0), new BlockPos(1,1,3), new BlockPos(3,3,4), ITMultiblockProvider.ALTERNATOR); }
