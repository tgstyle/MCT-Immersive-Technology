...
public class BoilerSolidShape extends GenericShape {
    ...
    private BoilerSolidShape(List<List<AABB>> shapes) { this.SHAPES = shapes; }

    static {
        int[] dims = loadDimensions("boiler_solid", "metal");
        ...
        if (WIDTH <= 0 || HEIGHT <= 0 || LENGTH <= 0) {
            ...
            if (error) {
                ...
                else { GETTER = new BoilerSolidShape(shapes); }
            }
        }
    }
