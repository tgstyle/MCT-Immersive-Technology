...
public class BoilerSolid extends ITTemplateMultiblock {
    ...
    public BoilerSolid() { super(ResourceLocation.fromNamespaceAndPath(ITLib.MODID, "multiblocks/boiler_solid"), new BlockPos(0,1,2), new BlockPos(0,1,2), new BlockPos(1,3,3), ITMultiblockProvider.BOILER_SOLID); }
