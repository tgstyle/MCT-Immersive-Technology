...
public class TrashEnergyIBlockEntity extends OSDCommonIBlockEntity implements IEnergyStorage, ITrashCanShape {
    public TrashEnergyIBlockEntity(BlockPos pos, BlockState state) { super(ITBlockEntities.TRASH_ENERGY.get(), pos, state); }
