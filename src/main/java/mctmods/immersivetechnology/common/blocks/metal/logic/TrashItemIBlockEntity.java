...
public class TrashItemIBlockEntity extends OSDCommonIBlockEntity implements IItemHandlerModifiable, ITBlockInterfaces.IInteractionObjectIT<TrashItemIBlockEntity>, ITrashCanShape, Container {
    public TrashItemIBlockEntity(BlockPos pos, BlockState state) { super(ITBlockEntities.TRASH_ITEM.get(), pos, state); }
    ...
    @Override public TrashItemIBlockEntity getGuiMaster() { return this; }

    @Override public ITMenuTypes.ArgContainer<? super TrashItemIBlockEntity, ?> getContainerType() { return ITMenuTypes.TRASH_ITEM; }
