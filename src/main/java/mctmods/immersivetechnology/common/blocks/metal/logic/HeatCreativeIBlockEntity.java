...
public class HeatCreativeIBlockEntity extends ITIBaseIBlockEntity {
    private final LazyOptional<IHeatProvider> providerCap = LazyOptional.of(Provider::new);

    public HeatCreativeIBlockEntity(BlockPos pos, BlockState state) { super(ITBlockEntities.HEAT_CREATIVE.get(), pos, state); }
