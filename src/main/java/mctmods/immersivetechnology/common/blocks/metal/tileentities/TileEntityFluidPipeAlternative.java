...
public class TileEntityFluidPipeAlternative extends blusunrize.immersiveengineering.common.blocks.metal.TileEntityFluidPipe implements IPipe {
    ...
    public int getConnectionStyle(int connection) {
        ...
        if(con instanceof TileEntityFluidPipeAlternative) {
            byte tileConnections = ((TileEntityFluidPipeAlternative)con).connections;
    ...
    public void onTilePlaced(World world, BlockPos pos, IBlockState state, EnumFacing side, float hitX, float hitY, float hitZ, EntityLivingBase placer, ItemStack stack) {
        ...
        for(EnumFacing dir : EnumFacing.values()) {
            if((te = world.getTileEntity(pos.offset(dir))) instanceof TileEntityFluidPipeAlternative) {
                if(((TileEntityFluidPipeAlternative)te).color != this.color) {
