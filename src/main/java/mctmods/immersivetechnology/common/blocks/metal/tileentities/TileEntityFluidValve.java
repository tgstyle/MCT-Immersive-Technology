...
public class TileEntityFluidValve extends TileEntityCommonValve implements IFluidHandler, IFluidPipe, IEBlockInterfaces.IBlockBounds {
	...
	public boolean hasCapability(@Nonnull final Capability<?> capability, final EnumFacing facing) {
        ...
        return capability == CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY && facing.getAxis() == this.facing.getAxis();
    }

    @SuppressWarnings({"unchecked", "NullableProblems"})
    @Override
    public @Nullable <T> T getCapability(@Nonnull final Capability<T> capability, final EnumFacing facing) {
