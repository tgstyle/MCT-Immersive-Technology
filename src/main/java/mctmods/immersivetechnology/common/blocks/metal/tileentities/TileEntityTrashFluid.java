...
public class TileEntityTrashFluid extends TileEntityCommonOSD implements IFluidTank, IFluidHandler, ITrashCanBounds {
    ...
    @Override
    public boolean hasCapability(@Nonnull Capability<?> capability, EnumFacing facing) { return capability == CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY; }
    ...
    @Override
    public FluidTankInfo getInfo() { return info; }
    ...
    @Nullable
    @Override
    public FluidStack drain(FluidStack fluidStack, boolean b) { return null; }
