...
public class TileEntityTrashFluid extends TileEntityCommonOSD implements IFluidTank, IFluidHandler, ITrashCanBounds {
    ...
    @Override public int getCapacity() { return Integer.MAX_VALUE; }

    @Override public FluidTankInfo getInfo() { return info; }

    @Override public IFluidTankProperties[] getTankProperties() { return tank; }
    ...
    @Nullable @Override public FluidStack drain(FluidStack fluidStack, boolean b) { return null; }
