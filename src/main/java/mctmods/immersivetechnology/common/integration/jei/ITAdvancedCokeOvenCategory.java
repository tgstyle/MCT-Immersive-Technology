...
public class ITAdvancedCokeOvenCategory extends ITRecipeCategory<AdvancedCokeOvenRecipe> {
    ...
    @Override
    public void draw(@NotNull AdvancedCokeOvenRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics graphics, double mouseX, double mouseY) { flame.draw(graphics, 31, 20); }
}
