...
public abstract class MultiblockITRecipe implements IMultiblockRecipe, IJEIRecipe {
    ...
    public void setupJEI() {
        ...
        if (this.outputList != null) {
            ...
            for(int i = 0; i < this.outputList.size(); ++i) {
                ...
                ArrayList<ItemStack> list = Lists.newArrayList(new ItemStack[]{!s.isEmpty() ? s.copy() : ItemStack.EMPTY});
        ...
        if (this.fluidInputList != null) {
            ...
            for(int i = 0; i < this.fluidInputList.size(); ++i) {
                FluidStack fs = (FluidStack)this.fluidInputList.get(i);
                if (fs != null) {
        ...
        if (this.fluidOutputList != null) {
            ...
            for(int i = 0; i < this.fluidOutputList.size(); ++i) {
                FluidStack fs = (FluidStack)this.fluidOutputList.get(i);
                if (fs != null) {
