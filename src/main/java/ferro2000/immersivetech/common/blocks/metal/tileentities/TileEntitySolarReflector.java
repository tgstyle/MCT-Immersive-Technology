...
public class TileEntitySolarReflector extends TileEntityMultiblockPart<TileEntitySolarReflector>
	...
	public List<AxisAlignedBB> getAdvancedSelectionBounds() {
		...
		if (pos == 0 || pos == 2) {
			...
			return Lists.newArrayList(new AxisAlignedBB(.25f, 0, .25f, .75f, 1, .75f).offset(getPos().getX(),
		...
		if (pos == 3 || pos == 5) {
			...
			return Lists.newArrayList(new AxisAlignedBB(.375f, 0, .375f, .625f, 1, .625f).offset(getPos().getX(),
					getPos().getY(), getPos().getZ()));
		...
		if (pos == 6 || pos == 8) {
			...
			List<AxisAlignedBB> list = Lists.newArrayList(new AxisAlignedBB(minX, 0, minZ, maxX, .5f, maxZ)
			...
			list.add(new AxisAlignedBB(minX, .5f, minZ, maxX, 1, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));
			...
			list.add(new AxisAlignedBB(minX, .25f, minZ, maxX, 1, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));
			...
			list.add(new AxisAlignedBB(minX, .125f, minZ, maxX, .25f, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));
		...
		if (pos == 9 || pos == 11) {
			...
			List<AxisAlignedBB> list = Lists.newArrayList(new AxisAlignedBB(minX, 0, minZ, maxX, 1, maxZ)
					.offset(getPos().getX(), getPos().getY(), getPos().getZ()));
			...
			list.add(new AxisAlignedBB(minX, 0, minZ, maxX, 1, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));

			list.add(new AxisAlignedBB(.375f, .375f, .375f, .625f, .625f, .625f).offset(getPos().getX(),
					getPos().getY(), getPos().getZ()));
			...
			minX = fl == EnumFacing.NORTH ? .625f
					: fl == EnumFacing.SOUTH ? .25f : fl == EnumFacing.EAST ? .125f : .625f;
			maxX = fl == EnumFacing.NORTH ? .75f
					: fl == EnumFacing.SOUTH ? .375f : fl == EnumFacing.EAST ? .375f : .875f;
			minZ = fl == EnumFacing.NORTH ? .625f
					: fl == EnumFacing.SOUTH ? .125f : fl == EnumFacing.EAST ? .625f : .25f;
			maxZ = fl == EnumFacing.NORTH ? .875f
					: fl == EnumFacing.SOUTH ? .375f : fl == EnumFacing.EAST ? .75f : .375f;

			list.add(new AxisAlignedBB(minX, .375f, minZ, maxX, .625f, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));

			minX = fl == EnumFacing.NORTH ? .625f
					: fl == EnumFacing.SOUTH ? .25f : fl == EnumFacing.EAST ? .625f : .125f;
			maxX = fl == EnumFacing.NORTH ? .75f
					: fl == EnumFacing.SOUTH ? .375f : fl == EnumFacing.EAST ? .875f : .375f;
			minZ = fl == EnumFacing.NORTH ? .125f
					: fl == EnumFacing.SOUTH ? .625f : fl == EnumFacing.EAST ? .625f : .25f;
			maxZ = fl == EnumFacing.NORTH ? .375f
					: fl == EnumFacing.SOUTH ? .875f : fl == EnumFacing.EAST ? .75f : .375f;
		...
		if (pos == 12 || pos == 14) {
			...
			List<AxisAlignedBB> list = Lists.newArrayList(new AxisAlignedBB(minX, .5f, minZ, maxX, 1, maxZ)
					.offset(getPos().getX(), getPos().getY(), getPos().getZ()));
			...
			list.add(new AxisAlignedBB(minX, 0, minZ, maxX, .5f, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));
			...
			list.add(new AxisAlignedBB(minX, .625f, minZ, maxX, .875f, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));
		...
		if (pos == 7) {
			...
			List<AxisAlignedBB> list = Lists.newArrayList(
					new AxisAlignedBB(0, .25f, 0, 1, 1, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
		...
		if (pos == 10) {
			...
			return Lists.newArrayList(new AxisAlignedBB(minX, 0, minZ, maxX, 1, maxZ).offset(getPos().getX(),
					getPos().getY(), getPos().getZ()));
		...
		if (pos == 13) {
			...
			list.add(new AxisAlignedBB(minX, 0, minZ, maxX, .25f, maxZ).offset(getPos().getX(), getPos().getY(),
					getPos().getZ()));
