package ferro2000.immersivetech.common.integration.Crafttweaker.boiler;
...
public class BoilerRecipeActions {
    ...
    private static class RemoveRecipe implements IAction {
        ...
        @Override
        public String describe() {
            return "Removing " + recipe.recipeCategoryName + " Recipe for '" + recipe.recipeName + "'";
        }
    }
    ...
    private static class AddFuel implements IAction {
        ...
        @Override
        public String describe() {
            return "Adding " + recipe.recipeCategoryName + " Fuel for '" + recipe.recipeName + "'";
        }
    }
    ...
    private static class RemoveFuel implements IAction {
        ...
        @Override
        public String describe() {
            return "Removing " + recipe.recipeCategoryName + " Fuel for '" + recipe.recipeName + "'";
        }
    }
