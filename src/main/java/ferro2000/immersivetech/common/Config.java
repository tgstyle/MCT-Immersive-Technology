...
public class Config {
	...
	public static class ITConfig {
		...
		public static class Machines {
			...
			@Comment({"How fast the Steam Turbine increases in torque per tick [Default=14]"})
			...
			@Comment({"How fast the Steam Turbine loses torque per tick when inactive [Default=28]"})
