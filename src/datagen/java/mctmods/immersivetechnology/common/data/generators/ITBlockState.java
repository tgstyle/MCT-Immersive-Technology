...
import mctmods.immersivetechnology.common.data.generators.blockstate.ITBasicStateGenerator;
import mctmods.immersivetechnology.common.data.generators.blockstate.ITMultiblockStateGenerator;
...
public class ITBlockState extends BlockStateProvider {
    ...
    private final ITMultiblockStateGenerator multiblockGen;
    private final ITBasicStateGenerator basicGen;
    ...
    public ITBlockState(DataGenerator generator, ExistingFileHelper helper) {
        ...
        this.multiblockGen = new ITMultiblockStateGenerator(this, helper);
        this.basicGen = new ITBasicStateGenerator(this, helper);
    }
    ...
    @Override @NotNull public BlockModelProvider models() { return blockModels; }

    @Override @NotNull public ItemModelProvider itemModels() { return itemModels; }
