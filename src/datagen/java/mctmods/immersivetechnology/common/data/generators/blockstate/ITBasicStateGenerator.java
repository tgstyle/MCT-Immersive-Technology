...
import mctmods.immersivetechnology.common.data.models.ITSideConfig;
...
public class ITBasicStateGenerator {
    ...
    public void generate() {
        ...
        BlockModelBuilder steelModel = main.models().getBuilder("block/metal/barrel_steel")
                .customLoader(ITSideConfig::begin)
    ...
    private void createValveVariants() {
        ...
        createValveState(ITBlocks.Metal.VALVE_FLUID.get(), valveClosed, valveOpen, VALVE_CONFIGS.get("fluid"), ValveCommonBlockEntity.OPEN);
    ...
    private void createValveState(Block block, ModelFile closedModel, ModelFile openModel, ValveRotationConfig config, @Nullable Property<Boolean> openProperty) {
        ...
        builder.forAllStates(state -> {
            ...
            if (block == ITBlocks.Metal.VALVE_FLUID.get()) {
    ...
    private ModelFile createConfiguredObjModel(String modelName, ResourceLocation objLoc, Map<String, Boolean> visibilityOverrides) {
        ...
        String particleTex = ITDataGenUtils.getTextureFromObj(particleObjLoc, existingFileHelper);
    ...
    protected void addParticleTextureFrom(BlockModelBuilder result, ModelBuilder<?> model) {
        ...
        if (particles != null) {
            ...
            ITBlockState.generatedParticleTextures.put(result.getLocation(), particles);
        }
    }
    ...
    public static class ITObjModelBuilder<T extends ModelBuilder<T>> extends net.neoforged.neoforge.client.model.generators.loaders.ObjModelBuilder<T> {
        private final java.util.Map<String, Boolean> visibility = new java.util.HashMap<>();
        protected ITObjModelBuilder(T parent, ExistingFileHelper existingFileHelper) { super(parent, existingFileHelper); }
        public static <T extends ModelBuilder<T>> ITObjModelBuilder<T> begin(@NotNull T parent, @NotNull ExistingFileHelper existingFileHelper) { return new ITObjModelBuilder<>(parent, existingFileHelper); }
        @NotNull public ITObjModelBuilder<T> visibility(@NotNull String part, boolean show) { visibility.put(part, show); return this; }
