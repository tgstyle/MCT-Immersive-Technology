...
public class ModParticle implements DataProvider {
    ...
    public ModParticle(PackOutput output) { this.particlesPath = output.createPathProvider(PackOutput.Target.RESOURCE_PACK, "particles"); }
