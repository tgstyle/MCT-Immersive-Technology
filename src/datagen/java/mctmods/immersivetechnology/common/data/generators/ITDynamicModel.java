...
public class ITDynamicModel extends ModelProvider<ITDynamicModel.SimpleModelBuilder> {
    private final ITBlockState multiblocks;

    public ITDynamicModel(ITBlockState multiblocks, PackOutput output, ExistingFileHelper existingFileHelper) { super(output, ITLib.MODID, "dynamic", rl -> new SimpleModelBuilder(rl, existingFileHelper), existingFileHelper); this.multiblocks = multiblocks; }
