...
public class DynamicModelProvider extends ModelProvider<DynamicModelProvider.SimpleModelBuilder> {
    ...
    public DynamicModelProvider(ModBlockState multiblocks, PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, Reference.MODID, "dynamic", rl -> new SimpleModelBuilder(rl, existingFileHelper), existingFileHelper);
